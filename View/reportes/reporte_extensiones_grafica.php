...
<main class="rep-page">
    <section class="rep-panel">
        ...
        <form method="get" action="<?= BASE_URL ?>/config/app.php" class="mb-4 d-flex gap-2 align-items-center flex-wrap">
            <input type="hidden" name="accion" value="editor.reporte.extensiones.grafica">
            ...
            <a class="btn btn-success"
                href="<?= BASE_URL ?>/config/app.php?accion=editor.reporte.extensiones.grafica.excel<?= $areaId ? '&areaId='.(int)$areaId : '' ?>">
                Exportar Excel
            </a>
        </form>
        <div class="row g-3">
