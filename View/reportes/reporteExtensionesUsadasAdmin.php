...
<div class="container rep-wrapper">
    ...
    <div class="rep-card">
        <div class="rep-card-header">
            ...
            <a href="<?= BASE_URL ?>/config/app.php?accion=admin.reporte.extensiones.usadas.pdf<?= $areaId ? '&areaId='.(int)$areaId : '' ?>" class="btn-small red">
                Exportar PDF
            </a>
        </div>
        <div class="rep-card-body">
            ...
            <form class="rep-filters" method="get" action="<?= BASE_URL ?>/config/app.php">
                <input type="hidden" name="accion" value="admin.reporte.extensiones.usadas">
