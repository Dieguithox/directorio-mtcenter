...
<div class="mb-3 d-flex align-items-center gap-2">
    ...
    <div class="ms-auto d-flex gap-2">
        <a href="<?= BASE_URL ?>/config/app.php?accion=editor.solicitudes.cambio"
            class="btn btn-sm <?= $estadoActual === '' ? 'btn-primary' : 'btn-outline-secondary' ?>">Todas</a>
        <a href="<?= BASE_URL ?>/config/app.php?accion=editor.solicitudes.cambio&estado=pendiente"
            class="btn btn-sm <?= $estadoActual === 'pendiente' ? 'btn-warning text-dark' : 'btn-outline-secondary' ?>">Pendientes</a>
        <a href="<?= BASE_URL ?>/config/app.php?accion=editor.solicitudes.cambio&estado=aprobado"
            class="btn btn-sm <?= $estadoActual === 'aprobado' ? 'btn-success' : 'btn-outline-secondary' ?>">Aprobadas</a>
        <a href="<?= BASE_URL ?>/config/app.php?accion=editor.solicitudes.cambio&estado=rechazado"
...
<div class="modal fade" id="modalAprobar" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content needs-validation" novalidate
            method="post"
            action="<?= BASE_URL ?>/config/app.php?accion=editor.solicitud.aprobar"
            id="formAprobar">
            <div class="modal-header">
...
<div class="modal fade" id="modalRechazar" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content needs-validation" novalidate
            method="post"
            action="<?= BASE_URL ?>/config/app.php?accion=editor.solicitud.rechazar"
            id="formRechazar">
            <div class="modal-header">
